    ...
    <div className="mt-10 p-3 rounded-md shadow-md bg-indigo-50">
      ...
      <div className="mt-10 text-md">
        <div className="mt-5 text-gray-700">
          <p className="uppercase text-sm">Termin boravka</p><p className="font-bold">od {booking?.selDates[0]} do {booking?.selDates[1]}</p>
        </div>
        <div className="mt-5 text-gray-700">
          <p className="uppercase text-sm">Broj osoba</p><p className="font-bold">{booking?.guestCount}</p>
        </div>
        <div className="mt-5 text-gray-700">
          <p className="uppercase text-sm">Ukupna cijena</p><p className="font-bold">{formatPrice(booking?.totalPrice)}</p>
        </div>
      </div>
